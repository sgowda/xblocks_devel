function [ab, ab_dtype] = mult_35x25(name, a, b, varargin)
...
[a_35bit, a_35bit_dtype] = round_to_wordlength(sprintf('%s_conv_35bit', name), a, 35, type_a, 'latency', conv_latency);
[b_25bit, b_25bit_dtype] = round_to_wordlength(sprintf('%s_conv_25bit', name), b, 25, type_b, 'latency', conv_latency);
[ab, ab_dtype] = mult(name, a_35bit, b_25bit, 'type_a', a_35bit_dtype, 'type_b', b_25bit_dtype, 'latency', mult_latency, 'full_precision', full_precision, 'type_ab', type_ab, 'quantization', quantization, 'overflow', overflow);
