...
if(accept_pcin == 0)
    DSP48E = xBlock(struct('source', 'DSP48E', 'name', 'DSP48E'), ...
                       struct('use_creg', 'on', ...
                              'addsub_mode', 'TWO24', 'use_op', 'on'), ...
                       {Reinterpret_A_out1, Reinterpret_B_out1, Reinterpret_C_out1, dsp48e_op}, ...
                       {DSP48E_out1});
else
    DSP48E = xBlock(struct('source', 'DSP48E', 'name', 'DSP48E'), ...
                       struct('use_creg', 'on', ...
                              ...
                              'addsub_mode', 'TWO24', ...
                              'use_op', 'on'), ...
                       {Reinterpret_A_out1, Reinterpret_B_out1, Reinterpret_C_out1, pcin, dsp48e_op}, ...
                       {DSP48E_out1});
end
...
dsp48e_op_gen = xBlock(struct('source', 'dsp48e_ctrl_init_xblock', 'name', 'dsp48e_op_gen'), ...
    {[blk, '/dsp48e_op_gen'], 'opmode', '0110011', 'alumode', alumode}, {}, {dsp48e_op});
