function multi_mat_input_data_cplx_init_xblock(blk, varargin)
...
for k=1:n_inputs
    ...
    blk_name_k = sprintf('from_workspace_cplx_%d', k);
    dout_k = xOutport(var_name_k);
    xBlock(struct('name', blk_name_k, 'source', @mat_input_data_cplx_init_xblock), ...
