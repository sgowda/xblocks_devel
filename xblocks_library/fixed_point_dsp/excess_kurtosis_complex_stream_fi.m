function [kappa_x, num, den, mean_power] = ...
    excess_kurtosis_complex_stream_fi(x_fi)
...
% Configure
acc_len = log2(length(x_fi));
type_x = fi_dtype(1, 18, 17);

% Calculate origin moments
[x_re_fi, x_im_fi, x_sq_re, x_sq_im, abs_x_sq, abs_x_4th, x_3rd_re, x_3rd_im] = kurtosis_origin_moments_fi(x_fi);
