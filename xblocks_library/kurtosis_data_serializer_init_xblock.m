...
% block: kurtosis_detector_serialization/pulse_ext/Constant10
Constant10_out1 = const('Constant10', pulse_len, fi_dtype(0, n_bits, 0));
% Constant10_out1 = xSignal('Constant10_out1');
% Constant10 = xBlock(struct('source', 'Constant', 'name', 'Constant10'), ...
%     struct('const', pulse_len, ...
%     'arith_type', 'Unsigned', ...
%     'n_bits', n_bits, ...
%     'bin_pt', 0, ...
%     'explicit_period', 'on'), ...
...
% block: kurtosis_detector_serialization/pulse_ext/Constant8
...
% block: kurtosis_detector_serialization/pulse_ext/Constant9
Constant9_out1 = const('Constant9', 1, fi_dtype(0, n_bits, 0));
% Constant9_out1 = xSignal('Constant9_out1');
% Constant9 = xBlock(struct('source', 'Constant', 'name', 'Constant9'), ...
...
% block: kurtosis_detector_serialization/pulse_ext/Counter
Logical1_out1 = xSignal('Logical1_out1');
...
% block: kurtosis_detector_serialization/pulse_ext/Logical
...
Logical = xBlock(struct('source', 'Logical', 'name', 'Logical'), ...
    [], ...
    {Relational2_out1, Relational1_out1}, ...
    {shift});

% block: kurtosis_detector_serialization/pulse_ext/Logical1
