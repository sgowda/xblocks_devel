function spect_power_init_xblock( blk, varargin )
...
bit_width = get_var('bitwidth', 'defaults', defaults, varargin{:});
...
elseif strcmp(impl_mode, 'behavioral')
    ...
    for k=1:n_inputs
        ...
        power_block_k = xBlock( power_config, ...
            {[], 'bit_width', bit_width, 'add_latency', add_latency, 'mult_latency', mult_latency}, ...
            {data_inports{k} }, ...
            {data_outports{k}});        
    end    
end
