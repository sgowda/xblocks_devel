...
for k=1:n_inputs
    ...
    xBlock(struct('source', 'cmult_behav_init_xblock', 'name', sprintf('cmult_%d', k)), ...
        {sprintf('%s/cmult_%d', blk, k), input_bit_width, input_bin_pt, coeff_bit_width, coeff_bin_pt, 0, ...
            'off', input_bit_width, input_bin_pt, quantization, overflow, 0, 'cplx_inputs', 1}, ...
        {din_del, coeffs}, {dout});    
end
